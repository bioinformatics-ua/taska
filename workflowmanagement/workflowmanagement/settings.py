...
def confirmation_path(obj, interested):

    return BASE_URL+'acceptAllByProcess/'
    return None

MAIL_LINKS = {
    "ProcessTaskAddTemplate":  ptask_path,
    "ProcessConfirmationTemplate": confirmation_path,
    "ProcessConfirmationTemplateAccept": confirmation_path,
    "ProcessConfirmationTemplateReject": confirmation_path,
}
